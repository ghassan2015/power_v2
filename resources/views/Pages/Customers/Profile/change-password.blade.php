        ...
        <div class="card card-custom">
            ...
            <div class="card-header py-3">
                <div class="card-title align-items-start flex-column">
                    <h3 class="card-label font-weight-bolder text-dark">تغير كلمة المرور</h3>
{{--                    <span class="text-muted font-weight-bold font-size-sm mt-1">Change your account password</span>--}}
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label text-alert"> كلمة المرورالحالية </label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <input type="password" name="تاكيد كلمة المرور"
                               class="form-control form-control-lg form-control-solid" value=""
